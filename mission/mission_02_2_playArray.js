...
** [미션 2-2 : 배열 다루기] **
  ...
  Q1. factorial 함수 만들기
    - 임의의 숫자(m)를 입력 받아 1부터 m까지의 factorial 값을 배열로 담아서 반환하는 함수를 만들자.

    calculate(4) -> [1, 2, 6, 24]


  Q2. 배열 거르기
    - 주어진 사람들 중 아래 조건을 만족하는 사람들로 구성된 배열을 만들어서 반환하는 함수를 만들자.
    - 조건 1) 특수기호가 없는 아이디 제외
    - 조건 2) 아이디에서 숫자를 제거
    - 조건 3) 2가지 버전으로 만들기 (for/wilte문 or 고차함수)
  ...
  Q3. 평균 구하기
    - 아래 예시는 학생 4명의 과목 점수이다. 각 학생의 평균점수(1)와 모든 학생의 최고 점수의 평균 점수(2)를 구하자.

    const grades = [[88,76,77], [33,44,44], [90,100,94], [30,44,98]];

  Q4. reduce 만들기 -> reduce처럼 동작하는 myReduce메서드를 만들자.
